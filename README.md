...
So when is the right time to use a generator? After we've gone over the actions
...
It allows more flexibility if you want to add some extra functionality to Active
Record.
